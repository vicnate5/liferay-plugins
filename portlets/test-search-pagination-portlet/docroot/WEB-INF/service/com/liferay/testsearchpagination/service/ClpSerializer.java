...
import com.liferay.testsearchpagination.model.FooClp;
...
public class ClpSerializer {
		...
		synchronized (ClpSerializer.class) {
			...
			try {
				...
				String portletPropsServletContextName = (String)getMethod.invoke(null,
						"test-search-pagination-portlet-deployment-context");
			...
			if (Validator.isNull(_servletContextName)) {
				_servletContextName = "test-search-pagination-portlet";
			}
	...
	public static Object translateOutput(BaseModel<?> oldModel) {
		...
		if (oldModelClassName.equals(
					"com.liferay.testsearchpagination.model.impl.FooImpl")) {
	...
	public static Throwable translateThrowable(Throwable throwable) {
		...
		if (className.equals(
					"com.liferay.testsearchpagination.exception.NoSuchFooException")) {
			return new com.liferay.testsearchpagination.exception.NoSuchFooException(throwable.getMessage(),
				throwable.getCause());
		}
