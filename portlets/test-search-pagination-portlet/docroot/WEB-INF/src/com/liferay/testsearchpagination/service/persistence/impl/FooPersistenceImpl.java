...
import com.liferay.testsearchpagination.exception.NoSuchFooException;
import com.liferay.testsearchpagination.model.Foo;
import com.liferay.testsearchpagination.model.impl.FooImpl;
import com.liferay.testsearchpagination.model.impl.FooModelImpl;
 ...
 * @author Inácio Nery
 * @see FooPersistence
 * @see com.liferay.testsearchpagination.service.persistence.FooUtil
 * @generated
 */
@ProviderType
public class FooPersistenceImpl extends BasePersistenceImpl<Foo>
	...
	protected Foo toUnwrappedModel(Foo foo) {
		...
		fooImpl.setFieldId(foo.getFieldId());
		fooImpl.setFieldName(foo.getFieldName());
